(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : ((global = global || self),
      factory((global.manifest = {}), global.React));
  ...
  var childrenFn =
    PropTypes && PropTypes.oneOfType([PropTypes.node, PropTypes.func]);
  var stateObject =
    PropTypes &&
    PropTypes.shape({
  ...
  var IfInitial = function IfInitial(_ref) {
    ...
    return React__default.createElement(
      ...
      null,
      state.isInitial || (persist && !state.data)
        ? renderFn(children, state)
        : null
    );
  }.bind(undefined);
  /**
  ...
  var IfPending = function IfPending(_ref2) {
    ...
    return React__default.createElement(
      React__default.Fragment,
      null,
      state.isPending && (!initial || !state.value)
        ? renderFn(children, state)
        : null
    );
  }.bind(undefined);
  ...
  var IfFulfilled = function IfFulfilled(_ref3) {
    ...
    return React__default.createElement(
      React__default.Fragment,
      null,
      state.isFulfilled || (persist && state.data)
        ? renderFn(children, state.data, state)
        : null
    );
  }.bind(undefined);
  /**
  ...
  var IfRejected = function IfRejected(_ref4) {
    ...
    return React__default.createElement(
      React__default.Fragment,
      null,
      state.isRejected || (persist && state.error)
        ? renderFn(children, state.error, state)
        : null
    );
  }.bind(undefined);
  /**
  ...
  var IfSettled = function IfSettled(_ref5) {
    ...
    return React__default.createElement(
      React__default.Fragment,
      null,
      state.isSettled || (persist && state.value)
        ? renderFn(children, state)
        : null
    );
  }.bind(undefined);
  ...
  var getStatusProps = function getStatusProps(status) {
    ...
    return {
      ...
      isSettled:
        status === exports.StatusTypes.fulfilled ||
        status === exports.StatusTypes.rejected,
    };
  }.bind(undefined);
  ...
  var dispatchMiddleware = function dispatchMiddleware(dispatch) {
    ...
    return function (action) {
      ...
      if (
        action.type === exports.ActionTypes.start &&
    ...
    (function (_React$Component) {
      ...
      function Async() {
        ...
        return _possibleConstructorReturn(
          this,
          _getPrototypeOf(Async).apply(this, arguments)
        );
      }
      ...
      (function (_React$Component2) {
        ...
        function Async(props) {
          ...
          _this2 = _possibleConstructorReturn(
            this,
            _getPrototypeOf(Async).call(this, props)
          );
          ...
          _this2.onResolve = _this2.onResolve.bind(
            _assertThisInitialized(_this2)
          );
          _this2.onReject = _this2.onReject.bind(
            _assertThisInitialized(_this2)
          );
          _this2.setData = _this2.setData.bind(_assertThisInitialized(_this2));
          _this2.setError = _this2.setError.bind(
            _assertThisInitialized(_this2)
          );
          ...
          _this2.state = _objectSpread2(
            ...
            }),
            {
              ...
              reload: function reload() {
                ...
                (_this4 = _this2).run.apply(
                  _this4,
                  _toConsumableArray(_this2.args)
                );
              }.bind(this),
          ...
          var devToolsDispatcher =
            globalScope.__REACT_ASYNC__.devToolsDispatcher;

          var _reducer = props.reducer || defaultOptions.reducer;

          var _dispatcher =
            props.dispatcher || defaultOptions.dispatcher || devToolsDispatcher;

          var reducer$1 = _reducer
            ...
            : reducer;
          var dispatch = dispatchMiddleware(
          ...
          },
          {
            ...
            value: function componentDidUpdate(prevProps) {
              var _this$props = this.props,
                ...
                watchFn =
                  _this$props$watchFn === void 0
                    ? defaultOptions.watchFn
                    : _this$props$watchFn,
              ...
              if (
                watchFn &&
                watchFn(
                  _objectSpread2({}, defaultOptions, {}, this.props),
                  _objectSpread2({}, defaultOptions, {}, prevProps)
                )
              ) {
                if (this.counter) this.cancel();
                return this.load();
            ...
            value: function onResolve(counter) {
              ...
              return function (data) {
                ...
                if (this.counter === counter) {
                  var onResolve =
                    this.props.onResolve || defaultOptions.onResolve;
                  this.setData(
                    data,
                    function () {
  ...
  function useAsync(arg1, arg2) {
    ...
    var setError = React.useCallback(
      function (error) {
        var callback =
          arguments.length > 1 && arguments[1] !== undefined
            ? arguments[1]
    ...
    var handleResolve = React.useCallback(
      function (count) {
        var _this2 = this;
    ...
    var handleReject = React.useCallback(
      function (count) {
        var _this4 = this;
    ...
    var start = React.useCallback(
      function (promiseFn) {
        ...
        counter.current++;
        return (lastPromise.current = new Promise(
          function (resolve, reject) {
            var _this7 = this;
    ...
    var reload = React.useCallback(
      function () {
        ...
        lastArgs.current
          ? run.apply(void 0, _toConsumableArray(lastArgs.current))
          : load();
      }.bind(this),
      [run, load]
    );
    ...
    if (
      options.suspense &&
      state.isPending &&
      lastPromise.current !== neverSettle
    ) {
      // Rely on Suspense to handle the loading state
    ...
    (function (_Error) {
      ...
      function FetchError(response) {
        ...
        _this12 = _possibleConstructorReturn(
          this,
          _getPrototypeOf(FetchError).call(
            this,
  ...
  function useAsyncFetch(resource, init) {
    ...
    var accept =
      headers["Accept"] ||
      headers["accept"] ||
      (headers.get && headers.get("accept"));
    ...
    var deferFn = React.useCallback(
      function (_ref4, _, _ref5) {
    ...
    var state = useAsync(
      _objectSpread2(
        {},
        options,
        _defineProperty({}, fn, isDefer ? deferFn : promiseFn)
      )
    );
    React.useDebugValue(
      state,
...
//# sourceMappingURL=react-async.umd.js.map
